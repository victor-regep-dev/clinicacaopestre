...
import { WHATSAPP, PHONE_DISPLAY, PHONE_LANDLINE, PHONE_LANDLINE_TEL } from "@/lib/site";
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr_1.2fr] gap-9 mb-10">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2.5 text-[0.9rem] list-none">
              ...
              <li><a href={`tel:${PHONE_LANDLINE_TEL}`} className="hover:text-brand-orange">☎️ {PHONE_LANDLINE}</a></li>
              <li>📍 Rua Manacá, 46</li>
              <li>Campestre · Santo André/SP</li>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2.5 text-[0.9rem] list-none"><li>Segunda a Sexta: 9h às 20h</li><li>Sábado: 9h às 18h</li><li>Domingo: fechado</li></ul>
          </div>
          <div>
